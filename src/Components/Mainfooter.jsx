  ...
  return (
    ...
    <Row>
        <Col md="4">
          ...
          <li><i><RiPhoneLine/> <a href="tel:8376014921">(8376014921)</a></i></li>
        <li><i> <AiOutlineMail/> <a href = "mailto: abhishekabhishek87810@gmail.com">abhishekabhishek87810@gmail.com</a></i></li>
          </ul>
        </Col>
        <Col md="4">
